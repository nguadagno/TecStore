...
\hline
\textbf{Partecipanti} & Cliente registrato, magazziniere \\
\hline
...
\textbf{Cliente} & \textbf{Sistema} & \textbf{Magazziniere}\\
...
& Mostra al cliente un elenco di articoli corrispondenti alla parola cercata. \\
Fa click su uno degli articoli. \\
& Reindirizza il cliente ad una pagina con i dettagli dell'articolo. \\
...
\begin{minipage}{12cm}
\begin{tabular}{p{4cm} p{4cm} p{3cm}}
\textbf{Cliente} & \textbf{Sistema} & \textbf{Centralinista} \\
...
& Reindirizza il cliente al form per la scrittura di un messaggio per l'assistenza clienti. \\
Scrive il messaggio.  \\
