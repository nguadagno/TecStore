...
GRANT UPDATE, SELECT, INSERT, REFERENCES, DELETE ON TABLE `tecstore`.`utente` TO 'cliente';
GRANT UPDATE, SELECT, INSERT, REFERENCES, DELETE ON TABLE `tecstore`.`ticket` TO 'cliente';
GRANT INSERT, SELECT, UPDATE, DELETE, REFERENCES ON TABLE `tecstore`.`messaggio` TO 'cliente';
...
GRANT UPDATE, SELECT, INSERT, DELETE, REFERENCES ON TABLE `tecstore`.`carrello` TO 'cliente';
GRANT UPDATE, SELECT, INSERT, DELETE, REFERENCES ON TABLE `tecstore`.`foto` TO 'cliente';
SET SQL_MODE = '';
