...
public class GestioneVendita {
	...
	public boolean inserimentoNuovoArticolo(String nome, String descrizione, String IDVenditore, int quantita, float prezzo, boolean rimborsabile) throws SQLException {
	...
	public boolean modificaArticolo(String nome, String descrizione, String IDVenditore, int quantita, float prezzo, boolean rimborsabile) throws SQLException {
		if (quantita < 1 || prezzo < 0.01 || nome.isEmpty() || descrizione.isEmpty() || IDVenditore.isEmpty())
			return false;
